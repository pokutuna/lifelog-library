...
object LogTokens {
  ...
  case class BtDetectLog(dateTime: Date, deviceName: String, address: String) extends DetectLog
  case class WifiDetectLog(dateTime: Date, deviceName: String, address: String, signal: Int) extends DetectLog with HasSignal
